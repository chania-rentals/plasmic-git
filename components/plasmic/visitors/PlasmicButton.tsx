...
import sty from "./PlasmicButton.module.css"; // plasmic-import: NMGxQxLJ6HL/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: jaIB-YqsC2f/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: sveTryCrlGn/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__hm0Rh)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__vVdk8)}
                role={"img"}
              />
            ),
