...
import sty from "./PlasmicButton.module.css"; // plasmic-import: b2XL0IwiA6k/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 77ZuBP6z4AB/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: yHBPIo_yd_O/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ksrRr)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___8SB9A)}
                role={"img"}
              />
            ),
